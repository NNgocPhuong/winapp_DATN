...
namespace Services
{
    ...
    {
        public AccountService() : base("manager", "account")
        {
        ...
        public void LoadStations(Action completed)
        {
            ...
            var service = CreateActionService("device-list", null);
        ...
        public void LoadPersons(Action completed)
        {
            ...
            var service = CreateActionService("user-list", null);
        ...
        public void AddUser(Document data, Action completed, string role = "Staff")
        {
            ...
            var service = CreateActionService("add-user", data);
            service.Role = role;
        ...
        {
            var service = CreateActionService("remove-user", null);
